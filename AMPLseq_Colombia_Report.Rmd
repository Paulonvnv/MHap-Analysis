...
if(file.exists('pairwise_relatedness_dist_matrix.csv')){
  pairwise_relatedness = as.matrix(read.csv('pairwise_relatedness_dist_matrix.csv', row.names = 'X'))
}else{
