...
pop_levels = c("Quibdo", "Buenaventura", "Guapi", 'Tumaco')
pop_colors = c("firebrick3", "dodgerblue3", "gold3", "darkseagreen3")
...
localities = data.frame(Localities = factor(c("Tumaco",
                                              "Guapí",
                                              "Buenaventura",
                                              "Quibdó"), levels = c("Tumaco",
                                                                    "Guapí",
                                                                    "Buenaventura",
                                                                    "Quibdó")),
                        long = -70,
                        lat = c(8, 10, 12, 14),
                        colors = c("darkseagreen3",
                                   "gold3",
                                   "dodgerblue3",
                                   "firebrick3"
                                   ))
...
drug_resistant_haplotypes = fx_drug_resistant_haplotypes(ampseq,
                                        ...
                                        na.var.rm = TRUE,
                                        filters = c('Population;Buenaventura,Quibdo,Guapi,Tumaco',                               'quarter_of_collection;2020-Q4,2021-Q1,2021-Q2,2021-Q3,2021-Q4,2022-Q1,2022-Q2,2022-Q3'))
...
drug_resistant_haplotypes$haplo_freq_plot+
  ...
  scale_fill_manual(values = c(
    'gray75',reds[3], blues[c(6,4)], # MDR2
    reds[c(8,7,2,6)], blues[c(6,5)], # DFHR
    'gray75',blues[c(2,3,6)], reds[c(5,7)], # DHPS
    reds[8], blues[6], #K13
    'gray75',blues[2:3], reds[c(5:8)], blues[2:4], reds[5:9] # MDR1
  ))+
