...
plot_poly_by_pop = ampseq[["pop_summary"]] %>% filter(pop %in% c("Quibdo", "Buenaventura", "Guapi", "Total")) %>% ggplot(aes(x = factor(pop, levels = c("Quibdo", "Buenaventura", "Guapi", "Total")),
                                                          y = prop_poly,
...
plot_relatedness_distribution_within = fx_plot_relatedness_distribution(
  ...
  fill_color = c("dodgerblue3", "gold3", "firebrick3", 'gray30'),
...
plot_network = fx_plot_network(relatedness_matrix = pairwise_relatedness,
                               ...
                               sample_id = 'samples',
                               group_by = 'Population',
                               levels = c("Quibdo", "Buenaventura", "Guapi", "missing data"),
                               colors = c("firebrick3", "dodgerblue3", "gold3", "gray75")
                              )
