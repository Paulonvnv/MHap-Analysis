...
```{r}
ampseq_object = mask_alt_alleles(ampseq_object, mask_formula = '(SNV_in_homopolymer == TRUE | INDEL_in_homopolymer == TRUE) & h_ij >= 0.5 & h_ijminor >= 0.5', ref_fasta = ref_fasta)
```
