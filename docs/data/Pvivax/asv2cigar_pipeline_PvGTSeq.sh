python ../../../malaria_amplicon_pipeline/malaria-amplicon-pipeline/ASV_to_CIGAR.py \
  -d /Users/pam3650/Documents/Github/MHap-Analysis/reference/Pviv_P01/PvGTSeq271_refseqs.fasta \
